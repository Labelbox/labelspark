...
dataSet_new = labelspark.create_dataset(client, unstructured_data,
                                        "Demo Dataset")
...
Weather_Classification = Classification(class_type=Classification.Type.RADIO,
...
Time_of_Day = Classification(class_type=Classification.Type.RADIO,
                             instructions="Time of Day",
                             options=[
                                 Option(value="Day"),
                                 Option(value="Night"),
...
project_demo2 = client.create_project(name="LabelSpark Demo Example",
...
bronze_table = labelspark.get_annotations(client, "ckolzeshr7zsy0736w0usbxdj",
                                          spark, sc)
